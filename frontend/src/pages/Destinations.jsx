...
const ALL_PLACES = [
  ...
  { id: 5, title: "Galle Fort", district: "Galle", category: "Historical", rating: 4.9, img: IMAGES.galleFort, desc: "A UNESCO World Heritage Site, showcasing a blend of Portuguese, Dutch, and British architecture.", duration: "Full Day", lat: 6.0278, lng: 80.2168, highlights: ["UNESCO Heritage", "Architecture", "Museums"], bestTime: "Year Round" },
  ...
  { id: 21, title: "Pituwala Natural Pool", district: "Galle", category: "Nature", rating: 4.7, img: IMAGES.pituwala, desc: "A hidden natural pool with crystal-clear water, ideal for relaxation and photography.", duration: "2 Hours", lat: 6.0230, lng: 80.2200, highlights: ["Natural Pool", "Photography", "Relaxing"], bestTime: "Year Round" },
  { id: 22, title: "Kanneliya Rainforest Reserve", district: "Galle", category: "Adventure", rating: 4.8, img: IMAGES.kanneliya, desc: "A lush rainforest rich in biodiversity, ideal for hiking and birdwatching.", duration: "Full Day", lat: 6.2586, lng: 80.3535, highlights: ["Rainforest", "Birdwatching", "Hiking"], bestTime: "Aug–Sep" },
  { id: 23, title: "Maduganga River Safari", district: "Galle", category: "Nature", rating: 4.8, img: IMAGES.maduganga, desc: "A picturesque lagoon and mangrove ecosystem, ideal for boat safaris.", duration: "3 Hours", lat: 6.2551, lng: 80.0340, highlights: ["Boat Safari", "Mangroves", "Nature"], bestTime: "Year Round" },
  { id: 24, title: "Thalpe Beach", district: "Galle", category: "Beaches", rating: 4.7, img: IMAGES.thalpe, desc: "Known for its iconic natural rock pools and peaceful coastline.", duration: "Half Day", lat: 5.9995, lng: 80.2780, highlights: ["Rock Pools", "Swimming", "Relaxing"], bestTime: "Nov–Apr" },
  { id: 25, title: "Mihiripenna Beach", district: "Galle", category: "Beaches", rating: 4.6, img: IMAGES.mihiripenna, desc: "A quiet beach with shallow waters, perfect for families and relaxation.", duration: "Half Day", lat: 5.9920, lng: 80.2665, highlights: ["Family Friendly", "Swimming", "Calm Waters"], bestTime: "Nov–Apr" },
  { id: 26, title: "National Maritime Museum", district: "Galle", category: "Historical", rating: 4.5, img: IMAGES.maritime, desc: "A museum showcasing the maritime history of Sri Lanka.", duration: "1 Hour", lat: 6.0268, lng: 80.2171, highlights: ["Museum", "Maritime History", "Artifacts"], bestTime: "Year Round" },
  { id: 27, title: "Matara Fort", district: "Matara", category: "Historical", rating: 4.5, img: IMAGES.mataraFort, desc: "A historical fort featuring colonial architecture and cultural landmarks.", duration: "2 Hours", lat: 5.9480, lng: 80.5353, highlights: ["Dutch Fort", "Colonial Architecture", "History"], bestTime: "Year Round" },
  { id: 28, title: "Coconut Tree Hill", district: "Matara", category: "Nature", rating: 4.9, img: IMAGES.coconut, desc: "A picturesque hill dotted with coconut trees, offering stunning ocean views.", duration: "1 Hour", lat: 5.9416, lng: 80.4503, highlights: ["Sunset Views", "Photography", "Ocean View"], bestTime: "Nov–Apr" },
  { id: 29, title: "Paravi Duwa Temple", district: "Matara", category: "Cultural", rating: 4.6, img: IMAGES.paravi, desc: "A small Buddhist temple on an island connected by a scenic bridge.", duration: "1 Hour", lat: 5.9470, lng: 80.5472, highlights: ["Island Temple", "Bridge", "Spiritual"], bestTime: "Year Round" },
  { id: 30, title: "Weherahena Temple", district: "Matara", category: "Cultural", rating: 4.7, img: IMAGES.weherahena, desc: "A Buddhist temple known for its massive Buddha statue and underground tunnels.", duration: "2 Hours", lat: 5.9947, lng: 80.5882, highlights: ["Buddha Statue", "Underground Tunnel", "Temple"], bestTime: "Year Round" },
  { id: 31, title: "Dellawa Tea Estate", district: "Deniyaya", category: "Nature", rating: 4.6, img: IMAGES.dellawa, desc: "A tranquil area surrounded by tea plantations and forests.", duration: "Half Day", lat: 6.3405, lng: 80.5581, highlights: ["Tea Estate", "Nature", "Photography"], bestTime: "Year Round" },
  { id: 32, title: "Ethamala Ella", district: "Deniyaya", category: "Nature", rating: 4.7, img: IMAGES.ethamala, desc: "A magnificent waterfall nestled in the jungle.", duration: "2 Hours", lat: 6.3482, lng: 80.5625, highlights: ["Waterfall", "Nature", "Adventure"], bestTime: "May–Sep" },
  { id: 33, title: "Lankagama", district: "Deniyaya", category: "Adventure", rating: 4.8, img: IMAGES.lankagama, desc: "A gateway village to the Sinharaja rainforest with breathtaking scenery.", duration: "Full Day", lat: 6.4064, lng: 80.4905, highlights: ["Village", "Rainforest", "Nature"], bestTime: "Aug–Sep" },
  { id: 34, title: "Kirinda Temple", district: "Hambantota", category: "Cultural", rating: 4.7, img: IMAGES.kirinda, desc: "A seaside Buddhist temple with historical significance and ocean views.", duration: "1 Hour", lat: 6.2232, lng: 81.3381, highlights: ["Temple", "Ocean View", "History"], bestTime: "Year Round" },
  { id: 35, title: "Sithulpawwa Rajamaha Viharaya", district: "Hambantota", category: "Historical", rating: 4.8, img: IMAGES.sithulpawwa, desc: "An ancient Buddhist monastery located in a tranquil forest setting.", duration: "3 Hours", lat: 6.4140, lng: 81.4223, highlights: ["Ancient Monastery", "Forest", "Spiritual"], bestTime: "Year Round" },
  { id: 36, title: "Rekawa Turtle Conservation", district: "Hambantota", category: "Wildlife", rating: 4.8, img: IMAGES.rekawa, desc: "A famous nesting site for sea turtles with guided conservation tours.", duration: "2 Hours", lat: 6.0351, lng: 80.8227, highlights: ["Sea Turtles", "Conservation", "Night Tours"], bestTime: "Year Round" },
  { id: 37, title: "Madunagala Hot Springs", district: "Hambantota", category: "Nature", rating: 4.6, img: IMAGES.madunagala, desc: "Natural thermal baths believed to have healing properties.", duration: "2 Hours", lat: 6.2921, lng: 80.9682, highlights: ["Hot Springs", "Relaxation", "Nature"], bestTime: "Year Round" },
  { id: 38, title: "Ussangoda National Park", district: "Hambantota", category: "Nature", rating: 4.7, img: IMAGES.ussangoda, desc: "A unique plateau with reddish soil and dramatic coastal scenery.", duration: "2 Hours", lat: 6.0805, lng: 80.9357, highlights: ["Red Soil", "Ocean Cliffs", "Photography"], bestTime: "Year Round" },
];
...
function ServiceLinksPanel({ selectedPlaces, onClose }) {
  const navigate = useNavigate();
  const district = selectedPlaces.length > 0 ? selectedPlaces[0].district : "";

  const services = [
    { icon: "🏨", label: "Find Hotels", desc: "Book stays near your route", color: "#4f46e5", path: "/hotels", query: `?district=${district}` },
    { icon: "🧭", label: "Hire a Guide", desc: "Local expert guides", color: "#0891b2", path: "/guides", query: `?district=${district}` },
    { icon: "🚗", label: "Book a Driver", desc: "Comfortable transfers", color: "#059669", path: "/drivers", query: `?district=${district}` },
    { icon: "🍽️", label: "Restaurants", desc: "Best eats along the way", color: "#d97706", path: "/restaurants", query: `?district=${district}` },
  ];

  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(10,22,40,0.7)", zIndex: 8000, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ background: "#fff", borderRadius: 28, width: "100%", maxWidth: 560, overflow: "hidden", boxShadow: "0 40px 100px rgba(0,0,0,0.4)" }}>
        {/* Header */}
        <div style={{ background: "linear-gradient(135deg, #0a1628, #1a3a5c)", padding: "28px 32px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 28, fontWeight: 800, color: "#f0c060", margin: 0 }}>Plan Your Trip</h2>
              <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 14, marginTop: 6 }}>
                {selectedPlaces.length} destination{selectedPlaces.length > 1 ? "s" : ""} selected — find services to complete your journey
              </p>
            </div>
            <button onClick={onClose} style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", color: "#fff", width: 36, height: 36, borderRadius: "50%", cursor: "pointer", fontSize: 16, display: "flex", alignItems: "center", justifyContent: "center" }}>✕</button>
          </div>
          {/* Selected places mini pills */}
          <div style={{ display: "flex", gap: 8, marginTop: 16, flexWrap: "wrap" }}>
            {selectedPlaces.map(p => (
              <div key={p.id} style={{ display: "flex", alignItems: "center", gap: 6, background: "rgba(240,192,96,0.15)", border: "1px solid rgba(240,192,96,0.3)", borderRadius: 999, padding: "4px 10px" }}>
                <img src={p.img} alt={p.title} style={{ width: 20, height: 20, borderRadius: "50%", objectFit: "cover" }} />
                <span style={{ fontSize: 12, color: "#f0c060", fontWeight: 600 }}>{p.title}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ padding: 28, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          {services.map(s => (
            <button key={s.label} onClick={() => navigate(s.path + s.query)}
              style={{ background: "#fafafa", border: "1.5px solid #efefef", borderRadius: 18, padding: "20px 18px", cursor: "pointer", textAlign: "left", transition: "all 0.2s", fontFamily: "inherit" }}
              onMouseEnter={e => { e.currentTarget.style.background = s.color + "10"; e.currentTarget.style.borderColor = s.color + "40"; e.currentTarget.style.transform = "translateY(-2px)"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "#fafafa"; e.currentTarget.style.borderColor = "#efefef"; e.currentTarget.style.transform = "none"; }}>
              <div style={{ fontSize: 36, marginBottom: 10 }}>{s.icon}</div>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#0a1628", marginBottom: 4 }}>{s.label}</div>
              <div style={{ fontSize: 13, color: "#9a8a6a" }}>{s.desc}</div>
              <div style={{ marginTop: 12, fontSize: 12, fontWeight: 700, color: s.color }}>Browse →</div>
            </button>
          ))}
        </div>
        ...
        <div style={{ padding: "0 28px 28px" }}>
          <button onClick={onClose}
            style={{ width: "100%", background: "linear-gradient(135deg, #f0c060, #c8973a)", color: "#0a1628", padding: "14px 0", borderRadius: 14, border: "none", cursor: "pointer", fontSize: 15, fontWeight: 800, fontFamily: "inherit" }}>
            Continue Exploring
          </button>
        </div>
      </div>
...
function useWeather(lat, lng, apiKey) {
  ...
  useEffect(() => {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lng}&appid=${apiKey}&units=metric`)
      ...
      .catch(() => setWeather({ temp: 30, feels: 33, humidity: 78, desc: "partly cloudy", code: 802, wind: 18 }))
...
function WeatherWidget({ lat, lng, locationName }) {
  const { weather } = useWeather(lat, lng, WEATHER_API_KEY);
  const w = weather || { temp: 30, feels: 33, humidity: 78, desc: "partly cloudy", code: 802, wind: 18 };
  return (
    <div style={{ background: "linear-gradient(135deg, #0f3460, #16213e)", borderRadius: 20, padding: "20px 24px", color: "#fff", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: -20, right: -20, width: 120, height: 120, background: "rgba(255,255,255,0.04)", borderRadius: "50%" }} />
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          <div style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", marginBottom: 4 }}>🌡️ Live Weather · {locationName}</div>
      ...
      <div style={{ display: "flex", gap: 20, marginTop: 16, paddingTop: 16, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        {[["Feels", `${w.feels}°`], ["Humidity", `${w.humidity}%`], ["Wind", `${w.wind} km/h`]].map(([l, v]) => (
  ...
  useEffect(() => {
    ...
    loadGoogleMaps(MAPS_API_KEY).then(() => {
      ...
      new window.google.maps.Marker({
        ...
        icon: { path: window.google.maps.SymbolPath.CIRCLE, scale: 14, fillColor: "#f0c060", fillOpacity: 1, strokeColor: "#0a1628", strokeWeight: 3 },
      });
    }).catch(() => {});
  }, [place]);
...
// ─── Route Map (FIXED: proper waypoint handling for 2+ places) ────────────────
function RouteMap({ selectedPlaces, userLocation, onClose, onShowServices }) {
  const mapRef = useRef(null);
  ...
  const buildRoute = useCallback(() => {
    if (!mapRef.current || !window.google || selectedPlaces.length === 0) return;
    const google = window.google;

    const centerLat = selectedPlaces[0].lat;
    const centerLng = selectedPlaces[0].lng;

    const map = new google.maps.Map(mapRef.current, {
      center: userLocation ? { lat: userLocation.lat, lng: userLocation.lng } : { lat: centerLat, lng: centerLng },
      zoom: 10,
      mapTypeId: "roadmap",
    });
    ...
    if (userLocation) {
      // Origin = user location, destination = last place, waypoints = all places in between
      ...
      waypoints = selectedPlaces.slice(0, -1).map(p => ({
        location: new google.maps.LatLng(p.lat, p.lng),
        stopover: true,
      }));
    } else if (selectedPlaces.length === 1) {
      // Only one place: origin = destination (show pin only)
      origin = new google.maps.LatLng(selectedPlaces[0].lat, selectedPlaces[0].lng);
      destination = new google.maps.LatLng(selectedPlaces[0].lat, selectedPlaces[0].lng);
      waypoints = [];
    } else {
      // Multiple places, no user location: first → last, middle = waypoints
      origin = new google.maps.LatLng(selectedPlaces[0].lat, selectedPlaces[0].lng);
      destination = new google.maps.LatLng(selectedPlaces[selectedPlaces.length - 1].lat, selectedPlaces[selectedPlaces.length - 1].lng);
      waypoints = selectedPlaces.slice(1, -1).map(p => ({
        location: new google.maps.LatLng(p.lat, p.lng),
        stopover: true,
      }));
    }

    if (selectedPlaces.length === 1 && !userLocation) {
      // Just show a marker
      new google.maps.Marker({
        position: { lat: selectedPlaces[0].lat, lng: selectedPlaces[0].lng },
        map,
        title: selectedPlaces[0].title,
        animation: google.maps.Animation.DROP,
      });
      setRouteInfo({ totalKm: "—", totalTime: "—", legs: [] });
      setLoading(false);
      return;
    }
    ...
    service.route({
      ...
      if (status === "OK") {
        ...
        setRouteInfo({
          ...
          legs: legs.map((l, i) => ({
            from: i === 0 && userLocation ? "📍 Your Location" : selectedPlaces[i].title,
            to: selectedPlaces[userLocation ? i : i + 1]?.title || selectedPlaces[selectedPlaces.length - 1].title,
            distance: (l.distance.value / 1000).toFixed(1),
            duration: Math.round(l.duration.value / 60),
          })),
        });
      } else {
        setError("Could not calculate route. Please check your API key.");
      }
      setLoading(false);
    });
  ...
  useEffect(() => {
    ...
    setError(null);
    loadGoogleMaps(MAPS_API_KEY).then(() => {
      // Small delay to ensure mapRef is fully mounted
  ...
  const mapsUrl = `https://www.google.com/maps/dir/${userLocation ? `${userLocation.lat},${userLocation.lng}/` : ""}${selectedPlaces.map(p => `${p.lat},${p.lng}`).join("/")}`;

  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(10,22,40,0.95)", zIndex: 10000, display: "flex", flexDirection: "column" }}>
      {/* Header */}
      <div style={{ background: "#0a1628", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(240,192,96,0.2)", flexShrink: 0 }}>
        <div>
          <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 28, fontWeight: 700, color: "#f0c060", margin: 0 }}>🗺️ Your Route</h2>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 13, margin: 0 }}>{selectedPlaces.length} stop{selectedPlaces.length > 1 ? "s" : ""} · {userLocation ? "From your location" : "Custom route"}</p>
        </div>
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          <button onClick={onShowServices}
            style={{ background: "linear-gradient(135deg, #f0c060, #c8973a)", color: "#0a1628", padding: "10px 20px", borderRadius: 999, border: "none", cursor: "pointer", fontSize: 13, fontWeight: 800, fontFamily: "inherit" }}>
            🏨 Book Services
          </button>
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <div style={{ width: 340, background: "#0d1f3c", overflowY: "auto", padding: 24, display: "flex", flexDirection: "column", gap: 16 }}>
          {routeInfo && routeInfo.totalKm !== "—" && (
            <div style={{ background: "linear-gradient(135deg, rgba(240,192,96,0.15), rgba(240,192,96,0.05))", border: "1px solid rgba(240,192,96,0.3)", borderRadius: 16, padding: 20 }}>
              <div style={{ display: "flex", gap: 16 }}>
                {[["totalKm", "Total KM"], ["totalTime", "Minutes"], [selectedPlaces.length.toString(), "Stops"]].map(([val, label], i) => (
                  <div key={label} style={{ flex: 1, textAlign: "center" }}>
                    {i > 0 && <div style={{ position: "absolute" }} />}
                    <div style={{ fontSize: 26, fontWeight: 700, color: "#f0c060" }}>{i === 2 ? selectedPlaces.length : routeInfo[val]}</div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: "auto", paddingTop: 8 }}>
            <button onClick={onShowServices}
              style={{ background: "linear-gradient(135deg, #f0c060, #c8973a)", color: "#0a1628", padding: "14px 0", borderRadius: 14, border: "none", cursor: "pointer", fontWeight: 800, fontSize: 14, fontFamily: "inherit" }}>
              🏨 Book Hotels, Guides & Drivers
            </button>
            <a href={mapsUrl} target="_blank" rel="noopener noreferrer"
              style={{ background: "rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.7)", padding: "12px 0", borderRadius: 14, fontWeight: 600, fontSize: 13, textDecoration: "none", display: "block", textAlign: "center", border: "1px solid rgba(255,255,255,0.1)" }}>
              Open in Google Maps ↗
            </a>
          </div>
        </div>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(10,22,40,0.96)", zIndex: 9000, overflowY: "auto", display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "40px 20px" }}>
      <div style={{ width: "100%", maxWidth: 900, background: "#fff", borderRadius: 28, overflow: "hidden", boxShadow: "0 40px 120px rgba(0,0,0,0.5)" }}>
        <div style={{ position: "relative", height: 350, overflow: "hidden" }}>
          ...
          <button onClick={onClose} style={{ position: "absolute", top: 20, right: 20, background: "rgba(0,0,0,0.5)", border: "1px solid rgba(255,255,255,0.3)", color: "#fff", width: 44, height: 44, borderRadius: "50%", cursor: "pointer", fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center" }}>✕</button>
        ...
        <div style={{ padding: "32px 32px 40px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {[["⏱️ Duration", place.duration], ["📅 Best Time", place.bestTime || "Year Round"], ["📍 Location", place.district + ", Sri Lanka"]].map(([label, value]) => (
            ...
            <div style={{ marginTop: 24 }}>
              <button onClick={() => { onSelect(place); onClose(); }}
                style={{ width: "100%", background: isSelected ? "#e8f5e9" : "linear-gradient(135deg, #0a1628, #1a2a4a)", color: isSelected ? "#2e7d32" : "#f0c060", padding: "14px 0", borderRadius: 14, border: isSelected ? "2px solid #4caf50" : "none", cursor: "pointer", fontSize: 15, fontWeight: 700, fontFamily: "inherit" }}>
                {isSelected ? "✓ Already Selected" : "➕ Add to Route"}
              </button>
            </div>
          </div>
      ...
      <div style={{ padding: "16px 18px 18px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          <button onClick={() => onView(place)}
            style={{ background: "linear-gradient(135deg, #0a1628, #1a2a4a)", color: "#f0c060", padding: "10px 0", borderRadius: 12, border: "none", cursor: "pointer", fontSize: 13, fontWeight: 700, fontFamily: "inherit" }}>
            👁️ View
          </button>
  ...
  return (
    <div style={{ position: "sticky", bottom: 0, zIndex: 500, background: "linear-gradient(135deg, #0a1628, #1a3a5c)", borderTop: "2px solid rgba(240,192,96,0.3)", padding: "16px 32px", boxShadow: "0 -8px 40px rgba(10,22,40,0.4)" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
        <div style={{ color: "#f0c060", fontWeight: 700, fontSize: 15, whiteSpace: "nowrap" }}>🗺️ {selectedPlaces.length} Selected</div>
        ...
        {!userLocation ? (
          <button onClick={requestLocation} style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.2)", color: "rgba(255,255,255,0.7)", padding: "8px 16px", borderRadius: 999, cursor: "pointer", fontSize: 12, fontFamily: "inherit", whiteSpace: "nowrap" }}>📍 Use My Location</button>
        ) : (
          <span style={{ fontSize: 12, color: "#4ade80", whiteSpace: "nowrap" }}>📍 Location Ready</span>
        )}
        <button onClick={onClear} style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)", padding: "8px 16px", borderRadius: 999, cursor: "pointer", fontSize: 12, fontFamily: "inherit" }}>Clear</button>
        <button onClick={onShowMap} style={{ background: "linear-gradient(135deg, #f0c060, #c8973a)", color: "#0a1628", padding: "10px 24px", borderRadius: 999, border: "none", cursor: "pointer", fontSize: 14, fontWeight: 800, fontFamily: "inherit", boxShadow: "0 4px 20px rgba(240,192,96,0.4)", whiteSpace: "nowrap" }}>
          🗺️ Show Route Map
        </button>
      </div>
    </div>
...
export default function Destinations() {
  ...
  useEffect(() => { loadGoogleMaps(MAPS_API_KEY).catch(() => {}); }, []);

  const requestLocation = () => {
    if (!navigator.geolocation) { setLocationError("Geolocation not supported"); return; }
    navigator.geolocation.getCurrentPosition(
      pos => setUserLocation({ lat: pos.coords.latitude, lng: pos.coords.longitude }),
      () => setLocationError("Location access denied. You can still plan your route.")
    );
  };
  ...
  const filtered = ALL_PLACES
    .filter(p => {
      ...
      return (p.title.toLowerCase().includes(q) || p.desc.toLowerCase().includes(q))
        && (districtFilter === "All Districts" || p.district === districtFilter)
  ...
  // ✅ FIXED handleSelect with Axios POST
  const handleSelect = (place) => {
    ...
    if (token) {
      axios.post('http://localhost:5004/api/destinations/select',
        {
          name: place.title,
      ...
      <div style={{ minHeight: "100vh", background: "#f5f0e8" }}>
        ...
        <div style={{ position: "relative", height: 520, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "0 24px" }}>
            <div style={{ background: "rgba(240,192,96,0.15)", border: "1px solid rgba(240,192,96,0.3)", color: "#f0c060", padding: "6px 20px", borderRadius: 999, fontSize: 13, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 20 }}>🌴 Down South Sri Lanka</div>
            <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(40px, 6vw, 72px)", fontWeight: 800, color: "#fff", lineHeight: 1.1, marginBottom: 20 }}>
              Explore Paradise<br /><span style={{ color: "#f0c060" }}>Destinations</span>
            </h1>
            <p style={{ fontSize: 18, color: "rgba(255,255,255,0.7)", maxWidth: 540, lineHeight: 1.7, marginBottom: 36 }}>
              {ALL_PLACES.length} handpicked destinations across Galle, Matara, Hambantota & Deniyaya.
            </p>
            <div style={{ width: "100%", maxWidth: 640, position: "relative" }}>
              <div style={{ position: "absolute", left: 20, top: "50%", transform: "translateY(-50%)", fontSize: 18, pointerEvents: "none" }}>🔍</div>
              <input type="text" placeholder="Search beaches, wildlife, cultural sites..." value={search} onChange={e => setSearch(e.target.value)}
              ...
              {search && <button onClick={() => setSearch("")} style={{ position: "absolute", right: 16, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", fontSize: 18, color: "#9a8a6a" }}>✕</button>}
            </div>
            <div style={{ display: "flex", gap: 32, marginTop: 36 }}>
              {[["38+", "Destinations"], ["4", "Districts"], ["9", "Categories"], ["Live", "Weather"]].map(([val, label]) => (
        ...
        {userLocation && (
          <div style={{ background: "linear-gradient(90deg, #0a1628, #0f3460)", padding: "12px 32px" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ color: "rgba(255,255,255,0.7)", fontSize: 13 }}>📍 Location detected — Route planning active. Select destinations and click "Show Route Map".</span>
        ...
        {locationError && (
          <div style={{ background: "rgba(239,68,68,0.1)", borderBottom: "1px solid rgba(239,68,68,0.2)", padding: "10px 32px" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto", fontSize: 13, color: "rgba(255,100,100,0.9)" }}>⚠️ {locationError}</div>
          </div>
        )}
        ...
        <div style={{ background: "#fff", borderBottom: "1px solid #e8e2d6", padding: "16px 32px", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 2px 20px rgba(0,0,0,0.06)" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
            ...
            <select value={sortBy} onChange={e => setSortBy(e.target.value)}
              style={{ padding: "8px 16px", borderRadius: 999, border: "1.5px solid #e8e2d6", fontSize: 13, color: "#0a1628", background: "#fdfaf5", cursor: "pointer", fontFamily: "inherit", outline: "none" }}>
              {["Top Rated", "Name A–Z"].map(s => <option key={s}>{s}</option>)}
            </select>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 28 }}>
              {filtered.map(place => (
                <div key={place.id} className="place-card">
                  <PlaceCard place={place} onView={setViewingPlace} onSelect={handleSelect} isSelected={isSelected(place)} />
                </div>
              ))}
            </div>
          )}
        ...
        <SelectedBar
          ...
          onRemove={id => setSelectedPlaces(prev => prev.filter(p => p.id !== id))}
        ...
        {/* MODALS */}
        {viewingPlace && (
          <PlaceDetailModal place={viewingPlace} onClose={() => setViewingPlace(null)} onSelect={handleSelect} isSelected={isSelected(viewingPlace)} />
        )}
        {showRouteMap && selectedPlaces.length > 0 && (
          <RouteMap
            ...
            onShowServices={() => { setShowRouteMap(false); setShowServices(true); }}
          />
        )}
        {showServices && (
          <ServiceLinksPanel selectedPlaces={selectedPlaces} onClose={() => setShowServices(false)} />
        )}
      </div>
    </>
  );
