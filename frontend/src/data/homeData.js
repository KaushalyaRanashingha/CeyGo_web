export const NAV_LINKS = [
  { name: "Destinations", type: "scroll" },
  { name: "Beach Stays", type: "scroll" },
  { name: "AI Planner", type: "scroll" },
  { name: "Events", type: "scroll" },
  { name: "Contact", type: "scroll" },

  { name: "Budget", type: "page", path: "/budget" },
  { name: "Weather", type: "page", path: "/weather" },
